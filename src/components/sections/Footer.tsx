        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold">Buy Box Cartel</h3>
                <p className="text-primary-foreground/70">Kenya</p>
              </div>
            </div>
            <p className="text-primary-foreground/80 mb-6 leading-relaxed max-w-sm">
              Revolutionizing real estate wholesale in Kenya by connecting serious buyers 
              with quality properties through smart matching technology.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-primary-foreground/80">hello@buyboxcartel.ke</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-primary-foreground/70">
              © 2024 Buy Box Cartel Kenya. All rights reserved.
            </div>
